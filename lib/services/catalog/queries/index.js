...
module.exports = function (service) {
	...
	function checkCache(bus, channel, object) {
		...
		// If we do not have a maxAge on the object.meta, optionally use a
		// fallback of the ODDWORKS_MAX_AGE environment variable
		const queryMaxAge = object.meta.maxAge || process.env.ODDWORKS_MAX_AGE;
		const maxAge = parseInt(queryMaxAge, 10) ? (queryMaxAge * 1000) : false;

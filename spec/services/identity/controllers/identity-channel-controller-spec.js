...
const IdentityChannelController = require('../../../../lib/services/identity/controllers/identity-channel-controller');

describe('Identity Channel Controller', function () {
	const type = 'channel';
	let bus;
	let handler;
	...
	beforeAll(function () {
		bus = this.createBus();
		handler = IdentityChannelController.create({bus});
